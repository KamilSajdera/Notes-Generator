  ...
  const options = useMemo(
    () => [
      { value: "none", label: "Select" },
      {
        ...
        label: "Semibreve [4/4]",
        disabled:
          ((currentLatency >= 1 && currentLatency < 16) ||
            currentLatency > 16) &&
          isDisabled,
      },
      {
        ...
        label: "Minim [2/4]",
        disabled:
          ((currentLatency > 8 && currentLatency < 16) ||
            currentLatency > 24) &&
          isDisabled,
      },
      {
        ...
        label: "Crotchet [1/4]",
        disabled:
          ((currentLatency > 12 && currentLatency < 16) ||
            currentLatency > 28) &&
          isDisabled,
      },
      {
        ...
        label: "Quaver [1/8]",
        disabled:
          ((currentLatency > 14 && currentLatency < 16) ||
            currentLatency > 30) &&
          isDisabled,
      },
    ],
